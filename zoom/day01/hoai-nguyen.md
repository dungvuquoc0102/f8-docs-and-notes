...
- Phần "It Feels Like We Don't Have Time" thiếu `<em>` cho từ `do` trong câu "you do have time". Nên sửa thành `you <em>do</em> have time`.

- Phần "Imagine Your Life After a Year of Learning" thiếu `<em>` cho từ `way` trong câu "look way better". Nên sửa thành `look <em>way</em> better`.
